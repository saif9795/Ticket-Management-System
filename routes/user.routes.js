...
router.get("/buses", verifyToken, authorizedRole("user"), async(req, res)=>{
    try {
...
router.get("/tickets", verifyToken, authorizedRole("user"), async(req, res)=>{
    try {
...
router.post("/tickets/purchase", verifyToken, authorizedRole("user"), async(req, res)=>{
    try {
